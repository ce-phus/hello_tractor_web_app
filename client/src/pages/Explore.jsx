    ...
    <Layout>
        {loading ? (
            <div className='flex flex-col justify-center items-center'>
                ...
                <div className='bg-white dark:bg-slate-800 h-3 w-1/4 rounded-lg animate-pulse mt-2'/>
                <div className='bg-white dark:bg-slate-800 h-4 w-1/3 rounded-lg animate-pulse mt-2'/>
                <div className='bg-white dark:bg-slate-800 h-3 w-1/4 rounded-lg animate-pulse mt-2'/>
